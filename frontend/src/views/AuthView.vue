    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          ...
          <button 
            ...
            class="px-4 py-2 ml-1 bg-white text-black font-medium rounded-lg border border-gray-300 hover:bg-gray-100 transition duration-300 focus:outline-none"
          >
            {{ 
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        ...
        <div v-if="authMode === 'login'" class="flex items-center justify-end">
          <div class="text-sm">
            <button 
              ...
              class="px-4 py-2 bg-white text-black font-medium rounded-lg border border-gray-300 hover:bg-gray-100 transition duration-300 focus:outline-none"
              :disabled="isLoading"
            >
        ...
        <div>
          <button
            type="submit"
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-black bg-white border-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            :disabled="isLoading"
            aria-live="polite"
          >
            <span class="absolute left-0 inset-y-0 flex items-center pl-3" aria-hidden="true">
              ...
              <svg v-else class="animate-spin -ml-1 mr-3 h-5 w-5 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div class="text-center mt-4">
        <router-link to="/" class="px-4 py-2 bg-white text-black font-medium rounded-lg border border-gray-300 hover:bg-gray-100 transition duration-300 focus:outline-none">
          Back to Home
        </router-link>
      </div>
    </div>
